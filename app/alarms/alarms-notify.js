(function () {
    ...
    function AlarmDirective() {
        return {
            ...
            '       <div>',
            '           <ul>',
            '               <li class="li-inline"><md-button class="alarm-close"  title="Hide Alarm Notification" ng-click="vm.hideAlarmNotification(alarm)"><span class="fa fa-eye-slash"></span></md-button></li>',
            '               <li class="li-inline"><md-button class="alarm-close"  title="Acknowledge Alarm" ng-click="vm.acknowledgeMessage(alarm)">Ack</md-button></li>',
            '               <li class="li-inline"><md-button class="alarm-close"  title="Know Alarm" ng-click="vm.knowMessage(alarm)">Know</md-button></li>',
            '           </ul>',
            '       </div>',
